 ...
 * Registrazione Cadetto - versione ottimizzata con miglior integrazione audio
 */
...
function renderCadetRegistration() {
    ...
    // Disegna il canvas con l'interfaccia
...
function drawCadetRegistrationCanvas() {
    ...
    // Aggiungiamo stelle in background
    for (let i = 0; i < 150; i++) {
    ...
    // Disegniamo l'astronave Raptor-X
