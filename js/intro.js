 ...
 * Versione aggiornata con supporto MP3
 */
...
function startIntroSequence() {
    ...
    // Disegna la navicella ma non il titolo nel canvas
    ...
    // Visualizza subito il crawler per evitare ritardi
...
function skipIntroVisuals() {
    ...
    // Ferma la musica intro
    if (window.AudioSystem) {
        if (typeof window.AudioSystem.stopAllMP3Music === 'function') {
            console.log("Stopping intro MP3 music.");
...
// Completa la registrazione cadetto e vai al gioco
